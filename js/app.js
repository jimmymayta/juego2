...
function data() {
  return [
    ...
    {
      question:
        "En la entrada triunfal, Jesús entró a Jerusalén montado sobre:",
      response: "un burrito",
    ...
    {
      question:
        "82- Cuando uno de los discípulos le cortó la oreja al siervo del sumo sacerdote,¿qué hizo Jesús?",
      response: "Tocó la oreja y lo sanó",
      reference: "Lucas 22:50-51",
    },
    {
      question: "83- David fue el rey de la nación de..",
      response: "Israel",
